...
import TenantImage from "../assets/Tenants.jpg"; // Import local image
...
const TenantLogin = () => {
  ...
  const handleLogin = (e) => {
    ...
    // Simulate successful login, then redirect to Tenant Dashboard
  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8">
        <h2 className="text-3xl font-bold mb-6 text-gray-900">Tenant Login</h2>
