 ...
 * Displays the logged-in user's customId (e.g., RC/TN/20250001/ABC) in authenticated views.
  ...
  const handleNotificationClick = () => {
    ...
    const notificationsPath =
      user?.role?.toLowerCase() === "landlord"
        ? "/dashboard/landlord/notifications"
        : "/dashboard/tenant/notifications";
    navigate(notificationsPath);
  };

  // Determine if logout button and authenticated view should be shown
        ...
        {user && shouldShowLogout ? (
          <>
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              />
              {/* User Info: Avatar and Custom ID */}
            ...
            <MobileMenu
              ...
              customId={user?.customId} // Pass customId to MobileMenu
            />
          </>
        ) : (
          <>
...
const MobileMenu = ({
  ...
  setDarkMode,
  customId, // Added prop for customId
}) => (
...
MobileMenu.propTypes = {
  ...
  setDarkMode: PropTypes.func.isRequired,
  customId: PropTypes.string, // Added prop type for customId
};

MobileMenu.defaultProps = {
  notificationCount: 0,
  customId: null, // Default to null if not provided
};
